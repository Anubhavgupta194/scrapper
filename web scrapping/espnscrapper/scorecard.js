...
function cb(err, response, html) {
  ...
  function extractMatchDetails(html) {
    ...
    //.status-text is on diffrent element so no need of space removal but this " match-info match-info-MATCH match-info-MATCH-half-width " all these classes are on same element so remove space
